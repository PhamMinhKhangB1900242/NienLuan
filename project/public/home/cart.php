...
if (!empty($_SESSION['cart'])) {
                        ...
                        <form method="post" action="thanhtoancart.php?action=addcart&id=' . $value['id'] . '">
                            ...
                            <td scope="col">
                                <a href="cart.php?action=remove&id=' . $value['id'] . '" >
                                    <button class="btn-custom btn-danger" >Xoá</i></button>
                                </a>
                            </td>
                        </tr>
    ...
    echo '</tbody>
        ...
        <tr>
            ...
            <th scope="col" >
            <a href="thanhtoan_cart.php" name="thanhtoancart"> <button class="btn btn-warning"><i class="fa-solid fa-cart-shopping"> </i> Đặt Hàng</a></a> 
            </th>
